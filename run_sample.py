...
if __name__ == '__main__':
    ...
    # Dataset
    parser.add_argument("--train_list", default="cell_data/train_aug.txt", type=str)
    parser.add_argument("--val_list", default="cell_data/val.txt", type=str)
    parser.add_argument("--infer_list", default="cell_data/train.txt", type=str,
